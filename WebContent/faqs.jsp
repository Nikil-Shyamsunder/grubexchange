...
<head>
  <title>FAQs | AppStrap Bootstrap Theme by Themelize.me</title>
  <meta charset="utf-8">
...
<body class="page page-faqs navbar-layout-default">
  ...
  <div id="content">
    <div class="container">
      ...
      <div id="js-filters-faq" class="cbp-l-filters-underline">
        ...
        <div data-filter=".buying" class="cbp-filter-item"> Buying </div>
        <div data-filter=".author" class="cbp-filter-item"> Author </div>
        <div data-filter=".account" class="cbp-filter-item"> Account </div>
        <div data-filter=".copyright" class="cbp-filter-item"> Copyright </div>
        <div data-filter=".community" class="cbp-filter-item"> Community </div>
      </div>
      <div id="js-grid-faq" class="cbp cbp-l-grid-faq" data-toggle="cbp" data-settings='{"filters":"#js-filters-faq", "defaultFilter": "*", "animationType":"sequentially", "gridAdjustment":"default", "displayType":"default", "caption":"expand", "gapHorizontal": 0, "gapVertical": 0}'>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                  ...
                  </svg> Where can I find my Purchase Code?
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                Every item purchased on Envato Market has a unique code, called a purchase code.
                <br> A purchase code is used by authors to verify you have purchased a licence for the item. The purchase code may be required to access an author�s support site (if support is offered) or to enable automatic updates.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </svg> Forum Comments by Envato Staff & Moderators
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Envato is extremely fortunate to have a huge community with highly engaged users. Part of our community�s time on Envato Market is spent within our forums, our common grounds for communication. In order to clarify the different roles and
                responsibilities of the various people and roles that post in our forums we hope you find the following information useful. </div>
            </div>
          </div>
        </div>
        <div class="cbp-item buying">
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                      ...
                      </svg> How Do I Get Support For An Item I've Purchased?
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Authors who are designers, developers and creatives from all over the globe are responsible for the work you see on Envato Market. Authors are not obligated to provide support, however most do. You will know if an author provides support,
                simply by viewing the �Support� tab on the item page. </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg> Which Author Payment Option Do I Choose?
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                As an Envato Market author you need to select the most appropriate payment method in order to receive your earnings.
                <br> Each payment method and provider may have restrictions regarding which countries they pay to, for legal and / or commercial reasons.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                          ...
                          </svg> Can I use trademarked names in my items?
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                ...
                <br> Using trademarked names to describe what your file actually is is acceptable. Using them to describe what your file is like is not.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg> Historical Payment Rates
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Over the years Envato Market has changed fees & rates several times � always in favour of our authoring community! If you have been selling files for some time, these rates may apply to you. If you are a new author, you should review our
                Current Rates or read about our author program If you are interested in Selling Your Work. </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                ...
                                </svg> Author Collaboration
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Authors may unofficially partner with other authors to create new items, but we advise strong caution when doing so. Envato Market considers the person who created an account and agreed to the terms and conditions to be the sole copyright
                holder of the items for sale and the only person eligible to withdraw any funds. </div>
            </div>
          </div>
        </div>
        <div class="cbp-item account">
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  </svg> How Do I Change My Password?
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                It is important that your Envato Account has a secure, private password at all times.
                <br> Sign in to your Envato Account via the button at the top right of the Envato Market sites.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg> An Author�s Introduction to Envato Market
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Becoming an author on Envato Market carries certain legal implications. Everything you sell must be your own original content. If you use any assets that are owned by someone else, you must have a license that grants you permission to use
                and resell them. </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      </svg> How to use the Whois Lookup Tool
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                ...
                <br> The contact details can be for both the domain�s registrar or the web hosting company providing space or storage for that specific website.
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        </svg> Illegal Distribution Of Files
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Envato Market is not a legal body which is qualified to give you advice on these matters. Any suggestions on this page are to be considered general and not specific to your situation. When sending legal documentation or taking any form of
                legal action, we recommend you consult with a legal professional. We can take no responsibility for the repercussions of following the suggestions in this document. </div>
            </div>
          </div>
        </div>
        <div class="cbp-item copyright">
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                          ...
                                          </svg> Protecting Your Copyright
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Some seek to fight all piracy they come across, some want to find ways to motivate users of content to pay for it, and some choose to focus on what they do sell and not change the ways of users who want all their content for free. Ultimately,
                this is your personal choice (and more below on the path Envato takes on the piracy issue). </div>
            </div>
          </div>
        </div>
        <div class="cbp-item buying">
          <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
              <svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            </svg> Buyers Guide to YouTube Content ID & Copyright Notices
            </div>
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body"> Content ID is a popular digital fingerprinting system that content creators can use to easily identify and manage their copyrighted content on YouTube. Videos uploaded to YouTube are compared against audio and video files registered with
                Content ID by content owners, looking for any matches. </div>
            </div>
          </div>
        </div>
        <div class="cbp-item community">
          <div class="cbp-caption">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-body">
                ...
                <br> All users who wish to participate or give feedback are invited to do so.
              </div>
            </div>
          </div>
        </div>
