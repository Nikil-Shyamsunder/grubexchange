  ...
  <!-- ======== @Region: #header ======== -->
   ...
   <div class="container">
		...
		<table class="table-striped table-bordered">
			...
			<tbody>
				<c:forEach items="${offered_grubs}" var="grub">
					<tr>
						<td>${grub.name}</td>
						...
						<td>
						<button type="button" class="mb-1 btn btn-green" onclick="window.location.href = 'AcceptOfferController?idgrub=${grub.idgrub}';">Accept Offer</button>
						</td>
					</tr>					
				</c:forEach>
			</tbody>
