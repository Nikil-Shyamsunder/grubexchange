      ...
      <div class="header-inner container">
        ...
        <div class="header-block-flex order-1 mr-auto">
          <nav class="nav nav-sm header-block-flex">
            ...
            <a class="nav-link text-xs text-uppercase d-none d-md-block" href="signup.html">Sign Up</a> <a class="nav-link text-xs text-uppercase d-none d-md-block" href="login.html">Login</a>
          </nav>
              ...
              <ul class="nav navbar-nav navbar-nav-stretch float-lg-right dropdown-effect-fade">
               ...
               <!-- Pages -->
                <li class="nav-item dropdown active">
                  <a href="about.html" class="nav-link" data-hover="dropdown">About</a>
                 
                </li>
                <li class="nav-item dropdown active">
                  <a href="contact.html" class="nav-link" data-hover="dropdown">Contact Us</a> 
                </li>
                <li class="nav-item dropdown active">
                  <a href="faqs.html" class="nav-link" data-hover="dropdown">FAQ</a> 
                </li>
