...
<h3>Grub I'm Receiving</h3>
		<table class="table-striped table-bordered">
			...
			<tbody>
					<tr>
						<td>${receivingGrub.name}</td>
						<td>${receivingGrub.description}</td>
						<td><c:if test="${receivingGrub.containsPeanuts == true}"> <a>Peanuts,</a> </c:if> <c:if test="${receivingGrub.containsEggs == true}"> <a>Egg,</a> </c:if> <c:if test="${receivingGrub.containsCowsmilk == true}"> <a>Cow's Milk,</a> </c:if> <c:if test="${receivingGrub.containsTreenuts == true}"> <a>Treenuts,</a> </c:if> <c:if test="${receivingGrub.containsShellfish == true}"> <a>Shellfish,</a> </c:if> <c:if test="${receivingGrub.containsWheat == true}"> <a>Wheat,</a> </c:if> <c:if test="${receivingGrub.containsSoy == true}"> <a>Soy</a> </c:if></td>
					</tr>					
			</tbody>
		</table>
...
<h3>Grub I'm Offering</h3>
		<table class="table-striped table-bordered">
			...
			<tbody>
					<tr>
						<td>${offeringGrub.name}</td>
						<td>${offeringGrub.description}</td>
						<td><c:if test="${offeringGrub.containsPeanuts == true}"> <a>Peanuts,</a> </c:if> <c:if test="${offeringGrub.containsEggs == true}"> <a>Egg,</a> </c:if> <c:if test="${offeringGrub.containsCowsmilk == true}"> <a>Cow's Milk,</a> </c:if> <c:if test="${offeringGrub.containsTreenuts == true}"> <a>Treenuts,</a> </c:if> <c:if test="${offeringGrub.containsShellfish == true}"> <a>Shellfish,</a> </c:if> <c:if test="${offeringGrub.containsWheat == true}"> <a>Wheat,</a> </c:if> <c:if test="${offeringGrub.containsSoy == true}"> <a>Soy</a> </c:if></td>
					</tr>					
			</tbody>
		</table>
